...
const GoogleMapAPI = ({ onChangeMarkerOn, posts, loading, user, markerOn }) => {
    ...
    return (
        <LoadScript googleMapsApiKey="AIzaSyCh2Dfsi0RTtFrKPTdMgTLWKgkT-MRRexg">
            <GoogleMap
            ...
            >
                ...
                {user && user.username == 'admin' && selected ? (
                    <InfoWindow
                        position={{
                            lat: selected.position.lat + 0.00025,
                ...
                {user && user.username != 'admin' && selected ? (
                    <InfoWindow
                        position={{
                            lat: selected.marker.position.lat + 0.00025,
                            lng: selected.marker.position.lng,
                        }}
                        onCloseClick={() => {
                            setSelected(null);
                        }}
