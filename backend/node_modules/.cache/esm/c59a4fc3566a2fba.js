let Post,mongoose,Joi,sanitizeHtml;_566‍.x([["getPostById",()=>getPostById],["checkOwnPost",()=>checkOwnPost],["write",()=>write],["list",()=>list],["read",()=>read],["remove",()=>remove],["update",()=>update]]);_566‍.w("../../models/post",[["default",["Post"],function(v){Post=v}]]);_566‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_566‍.w("@hapi/joi",[["default",["Joi"],function(v){Joi=v}]]);_566‍.w("sanitize-html",[["default",["sanitizeHtml"],function(v){sanitizeHtml=v}]]);   // 모델 
    // ObjectId 검증
        // Request Body 검증
// import Joi from 'joi';
   // HTML 필터링
